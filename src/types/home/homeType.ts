import { CommonQueryParams } from 'types/common';

// API Params
interface BoardListParams extends CommonQueryParams {
  staff_no: number;
  search_type: 1 | 2; // 1: 공지사항, 2: 자료실
}
interface SalesTermsParams extends CommonQueryParams {
