...
const useDetailList = (params: EtcListParams) => { 
    ...
    return useQuery<any, AxiosError>(['etc_order_detail_list', params.from_date, params.to_date, params.fran_store], () => queryFn.getDataList(reqData), {
        keepPreviousData: false,
        refetchOnWindowFocus: false,
        retry: false,
        suspense: false,  
