    ...
    <article>
      <section className="login-widget">
        <div className="inner">
          ...
          {authKeyPage ? (
            <SendAuthKey
              handleSendAuthKey={handleSendAuthKey}
              handleLoginAuth={handleLoginAuth}
              setAuthKeyPage={setAuthKeyPage}
            />
          ) : (
              ...
              <div className="sub-wrap">
                <div className="id-storage">
                  <input
                    ...
                    id="id"
                    onChange={handleChangeData}
                    checked={loginInfo.chkSaveID}
                  />
                  <label htmlFor="id">아이디 저장</label>
                </div>
                <button className="password-modify" onClick={() => handleSendTempPW(true)}>
                  비밀번호 재설정
                </button>
              </div>
              <button className="btn-cta" onClick={handleSendAuthKey}>
                로그인
              </button>
            </section>
          )}
