...
const CONTAINER_CLASS_NAME = {
  ...
  [PAGE_URL.CALCULATE + PAGE_URL.CALCULATE_LIST]: 'min-width-1400',
  [PAGE_URL.CALCULATE + PAGE_URL.CALCULATE_POINT]: 'min-width-1400',
  [PAGE_URL.CALCULATE + PAGE_URL.CALCULATE_COUPON]: 'min-width-1400',
  [PAGE_URL.CALCULATE + PAGE_URL.CALCULATE_CLAIM]: 'min-width-1800',
  [PAGE_URL.CALCULATE + PAGE_URL.CALCULATE_ETC]: 'min-width-1400',
  [PAGE_URL.CALCULATE + PAGE_URL.CALCULATE_AFFILIATE]: 'min-width-1400',
  [PAGE_URL.ETC]: 'min-width-1600',
  [PAGE_URL.SALES + PAGE_URL.SALES_HISTORY]: 'min-width-2200',
  ...
  [PAGE_URL.EVENT_COUPON]: 'min-width-1600',
