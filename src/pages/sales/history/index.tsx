...
// 				</div>
// 				{/* <!-- 주문내역 Table --> */}
// 				<SalesHistoryTable data={historyData() || []} isLoading={isLoading || isRefetching} rowPerPage={rowPerPage} currentPage={currentPage} ref={tableRef} />
// 			</div>
// 			{/* <!-- 엑셀다운, 페이징, 정렬 --> */}
// 			<div className='result-function-wrap'>
// 				<div className='function'>
