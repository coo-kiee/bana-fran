...
//       handleSearch: () =>
//         setQueryTriggerDate((prev) => ({ queryFromDate: searchCondition.from, queryToDate: searchCondition.to })),
//     }),
...
//   const { data: pointDetailList } = CALCULATE_SERVICE.useCalculatePointDetailList(
//     fCode,
//     staffNo,
//     queryFromDate,
//     queryToDate,
...
//       // 합계 계산
//       if (pointDetail.bonus_point_type)
//         totalObj[pointDetail.bonus_point_type as keyof TotalInfo].sum += pointDetail.total_bonus_amt;
//       if (pointDetail.use_point_type)
//         totalObj[pointDetail.use_point_type as keyof TotalInfo].sum += pointDetail.total_paid_amt;
//       totalObj.전체포인트.sum += pointDetail.total_amt;

//       // 필터링 조건
//       const isPointType =
//         searchOption[0].value === POINT_TYPE_OPTION[POINT_TYPE.ALL].value ||
//         searchOption[0].value === pointDetail.use_point_type ||
//         searchOption[0].value === pointDetail.bonus_point_type;
//       const isDeviceType =
//         searchOption[1].value === DEVICE_TYPE_OPTION[DEVICE_TYPE.ALL].value ||
//         searchOption[1].value === pointDetail.rcp_type;
