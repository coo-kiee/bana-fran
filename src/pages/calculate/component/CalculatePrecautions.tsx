...
const PRECAUTIONS_INFO = {
    [CALCULATE_TYPE.LIST]: ['※ 직전 월 정산내역을 확인 후 [정산확인]을 완료하시면 본사에서 세금계산서를 발행합니다.', '※ 당월 5일까지 직전월의 정산확인을 하지 않을 시 자동으로 정산확인 완료 처리됩니다.'],
    ...
    [CALCULATE_TYPE.CLAIM]: ['※ 해당 가맹점의 과실로 인한 고객 클레임을 보상하기 위해 본사에서 임의 발행한 ‘서비스 쿠폰’에 대한 청구 내역을 조회할 수 있습니다.'],
