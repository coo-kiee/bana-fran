...
const CalculateDetailTableBottom = <T,>({
  fCodeName,
  titleFrom,
  titleTo,
  colspan,
  ...
  handleCurrentPage,
  handleRow,
}: CalculateDetailTableBottomProps<T>) => {
      ...
      {!!dataCnt && (
        <>
          <div className="result-function-wrap">
            ...
            <Pagination
              dataCnt={dataCnt}
              handlePageChange={handleCurrentPage || handlePageChange}
              handlePageRow={handleRow || handlePageRow}
