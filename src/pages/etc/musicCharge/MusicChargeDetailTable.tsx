...
// type, constants
import { DetailTableProps, MusicChargeDetailType } from 'types/etc/etcType';
...
const MusicChargeDetailTable: FC<DetailTableProps> = ({ searchDate: { fromDate, toDate }, tabType }) => {
  const {
